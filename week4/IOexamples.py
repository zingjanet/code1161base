...
def be_cool_for_ever(name, file_path):
    """Save a message about Mika being cool for ever."""
...
be_cool_for_ever("Mika", "Mika_is_cool.txt")
be_cool_for_ever("Mika", "week4/Mika_is_cool.lol_UR_joking")
be_cool_for_ever("Mika", "../Mika_is_cool.periscope")
